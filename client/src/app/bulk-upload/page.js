    ...
    <AppLayout allow={["admin"]}>
      ...
      <div className="card-form" style={{ maxWidth: 640 }}>
        ...
        <ul className="small text-muted mb-0">
          ...
          <li><strong>Records</strong>: set the <code>billable</code> column to <code>true</code>/<code>yes</code>/<code>1</code> to auto-create a Change Order for that submission, exactly like the Add/Edit Record form does — re-running the upload won&apos;t create duplicates for a record that already has one.</li>
